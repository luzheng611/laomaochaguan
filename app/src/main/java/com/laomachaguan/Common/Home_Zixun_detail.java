 ...
 */
public class Home_Zixun_detail extends AndroidPopupActivity implements View.OnClickListener, PL_List_Adapter.onHuifuListener {
...
//    }
    ...
    protected void onSysNoticeOpened(String s, String s1, Map<String, String> map) {
        ToastUtil.showToastShort("三方通知到达");
    }
