...
import static com.laomachaguan.R.id.cost;
    ...
    public static class DdAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                holder = new Holder();
                holder.cost = (TextView) view.findViewById(cost);
                holder.name = (TextView) view.findViewById(R.id.username);
                holder.money = (TextView) view.findViewById(money);
