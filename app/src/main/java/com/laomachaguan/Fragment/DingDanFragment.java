        ...
        public class itemAdapter extends BaseQuickAdapter<HashMap<String, String>> {
            ...
            protected void convert(BaseViewHolder holder, HashMap<String, String> map) {
                ...
                if(map.get("spec")!=null&&!map.get("spec").equals("")){
                    ...
                    ((TextView) holder.getView(R.id.tags)).setVisibility(View.VISIBLE);
                    ((TextView) holder.getView(R.id.tags)).setText(tag.get("name")+";"+tag.get("spec_name"));
                }else{
                    ((TextView) holder.getView(R.id.tags)).setVisibility(View.GONE);
                }
            }
        }
