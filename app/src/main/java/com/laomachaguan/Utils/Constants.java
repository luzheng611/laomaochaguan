...
//    public static final String host_Ip = "http://yintolo.net";
    ...
    public static final String M_id = "20";
    public  static final String NAME_LOW="lmcg";
...
//    public static final String Phone_Commit_Ip = host_Ip + oooooo + "Dzhqsjhm";
    ...
    //单个商品属性列表
    public static final String Goods_spec= host_Ip + iiiiii + "Goods_spec";
    //商品增加属性类别
    public static final String Goods_spec_add= host_Ip + iiiiii + "Goods_specadd";
    //单个商品属性类别删除
    public static final String Goods_spec_delete= host_Ip + iiiiii + "Goods_specdelete";

    //单个商品属性类别修改
    public static final String Goods_spec_update= host_Ip + iiiiii + "Goods_specupdate";
    //资讯发布接口
...
//    //约功能条件信息获取接口
    ...
    //全局标签列表
    public static final String SpecList= host_Ip + iiiiii + "Speclist";
    //标签1删除
    public static final String SpecDelete= host_Ip + iiiiii + "Specdelete";
    //标签1增加
    public static final String SpecAdd= host_Ip + iiiiii + "Specadd";
    //标签2删除
    public static final String Spec2Delete= host_Ip + iiiiii + "Spec_infodelete";
    //标签2增加
    public static final String Spec2Add= host_Ip + iiiiii + "Spec_infoadd";


    //推送
    public static final String AdminPush= host_Ip + iiiiii + "Adminpush";

    //资讯置顶
    public static final String Draft_ZhiDing= host_Ip + oooooo + "Draftzd";
    //图片上传
