...
public class myHomePagerAdapter extends FragmentPagerAdapter {
    ...
    private int images[]={R.drawable.shouye_sel,R.drawable.simiao_sel,R.drawable.sel_majiang,R.drawable.mine_sel};
    public myHomePagerAdapter(Context context, android.support.v4.app.FragmentManager fm, List<Fragment> list) {
        super(fm);
        this.list=list;
