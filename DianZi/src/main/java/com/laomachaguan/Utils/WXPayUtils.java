...
//创建root
    ...
    public static void openWXPay(final Activity context, final String allmoney, final String attachId, final String title, final String num, final String type, final String number,final String spec_id) {
