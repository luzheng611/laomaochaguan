    ...
    public static class DdAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if(map.get("spec")!=null){
                HashMap<String ,String > m= AnalyticalJSON.getHashMap(map.get("spec"));
                holder.tag.setText(("0".equals(m.get("name"))||m.get("name")==null?"无":m.get("name"))+";"+("0".equals(m.get("spec_name"))||m.get("spec_name")==null?"无":m.get("name")));
            }else{
                holder.tag.setText("");
            }
