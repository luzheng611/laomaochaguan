            ...
            OkHttpUtils.post(Constants.Order_detail)
                ...
                public void onSuccess(String s, Call call, Response response) {
                    ...
                    if (oldMap != null) {
                        ...
                        if(oldMap.get("contents")!=null&&!oldMap.get("contents").equals("")){
                            LogUtil.e("电脑操作：："+oldMap.get("contents"));
        ...
        switch (view.getId()) {
            ...
            case R.id.button:
                ...
                try {
                    ...
                    js.put("contents1", edt_content.getVisibility()==GONE?html:edt_content.getText().toString().trim());
