...
public class myHomePagerAdapter extends FragmentPagerAdapter {
    ...
    private Context context;//,R.drawable.sel_majiang
    private int images[]={R.drawable.shouye_sel,R.drawable.simiao_sel,R.drawable.simiao_sel,R.drawable.simiao_sel,R.drawable.mine_sel};
